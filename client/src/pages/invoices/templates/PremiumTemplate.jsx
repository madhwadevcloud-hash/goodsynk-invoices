  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer} fixed><Text style={styles.small}>Powered by <Text style={{ fontSize: 8, fontFamily: 'Helvetica' }}>™</Text>Goodsynk Invoices</Text><View style={styles.signature}>{biz?.businessSignature && <Image src={biz.businessSignature} style={{ height: 28, objectFit: 'contain' }} />}<Text style={styles.small}>Authorised signature</Text>{biz?.businessSeal && <Image src={biz.businessSeal} style={{ height: 40, width: 40, objectFit: 'contain', marginTop: 2 }} />}</View></View>
      </Page>
    </Document>
  );
}