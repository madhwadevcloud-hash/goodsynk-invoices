...
export default function Template1({ invoice }) {
  ...
  const s = StyleSheet.create({
    ...
    footerBox: { position: 'absolute', bottom: 0, left: 0, right: 0, height: 40, backgroundColor: PRIMARY, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 30 },
